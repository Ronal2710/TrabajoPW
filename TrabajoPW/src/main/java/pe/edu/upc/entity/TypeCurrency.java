...
public class TypeCurrency implements Serializable {
	...
	@Pattern(regexp = "[^!\"#$%&'()*+,-./:;<=>?@^_`{|}~]+", message = "El nombre del tipo de moneda no puede contener un caracter especial")
	@Pattern(regexp = "[^0-9]+", message = "El nombre del tipo de moneda no puede contener un número")
