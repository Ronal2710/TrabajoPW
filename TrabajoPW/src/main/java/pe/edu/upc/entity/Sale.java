...
//	private Double amountSale;
	...
	public Sale(int idSale, @Positive int quantitySale, Date dateSale, Product product,
			User user) {
...
//	}
//
//	public void setAmountSale(Product product, @Positive int quantitySale) {
//		Double b;
//		b= (double) quantitySale;
//		
//		this.amountSale = b*product.getPriceProduct();
//	}
